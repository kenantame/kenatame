...
SUDO = SUDO
sudo_users = {SUDO,1365784590,400866650}   
print([[
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/kenatameNTEAM/Files_kenatame/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevkenatameW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevkenatameW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevkenatameW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevkenatameW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevkenatameW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevkenatameW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevkenatameW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1365784590) then  
var = true  
...
local UserName = (data.username_ or "Sourcekenatamee")
...
local kenatame_Msg = ''  
if msgs < 100 then 
kenatame_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
kenatame_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
kenatame_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
kenatame_Msg = 'متفاعل' 
elseif msgs < 1200 then 
kenatame_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
kenatame_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
kenatame_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
kenatame_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
kenatame_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
kenatame_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
kenatame_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
kenatame_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
kenatame_Msg = 'رب التفاعل'  
end 
return kenatame_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function Sourcekenatame(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
if DevkenatameW(msg) then
local bl = ' *⌔︙اهلا عزيزي آلمـطـور*\n*⌔︙آنت آلمـطـور آلآسـآسـي للبوت*\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n*⌔︙تسـتطـيع‌‏ آلتحگم باوامر البوت*\n*⌔︙من خلاال الكيبورت خاص بك*\n*⌔︙قناة سورس البوت *[اضغط هنا](t.me/Sourcekenatamee)'
local keyboard = {
...
if start then 
Sourcekenatamer = start
else
Namot = (database:get(bot_id..'Name:Bot') or 'القياده')
Sourcekenatamer = '*⌔︙اهلا عزيزي*\n*⌔︙انا بوت اسمي '..Namot..'*\n*⌔︙اختصاصي حمايه الكروبات*\n*⌔︙من تكرار والسبام والتوجيه والخ…*\n*⌔︙لتفعيلي اتبع الاخطوات…↓*\n*⌔︙اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط*\n⌔︙[قناة سورس البوت](http://t.me/Sourcekenatamee)'
end
send(msg.chat_id_, msg.id_, Sourcekenatamer) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevkenatameW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevkenatameW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,kenatame_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ⌔' and DevkenatameW(msg) then  
...
if text == 'تعطيل التواصل ⌔' and DevkenatameW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌔' and DevkenatameW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌔' and DevkenatameW(msg) then  
...
if text == 'ضع كليشه ستارت ⌔' and DevkenatameW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌔︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌔' and DevkenatameW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌔︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌔' and DevkenatameW(msg) then 
...
if text == 'تحديث السورس ⌔' and DevkenatameW(msg) then 
os.execute('rm -rf kenatame.lua')
os.execute('wget https://raw.githubusercontent.com/kenantame/kenatame/main/kenatame.lua')
send(msg.chat_id_, msg.id_,' *⌔︙تم تحديث السورس* \n*⌔︙لديك اخر اصدار لسورس القياده*\n*⌔︙الاصدار » { 2.8v}*')
dofile('kenatame.lua')  
end
if text == 'الاصدار ⌔' and DevkenatameW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌔︙اصدار سورس القياده* \n*⌔︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌔' and DevkenatameW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌔︙[تحديثات البوت](t.me/Sourcekenatamee) \n⌔︙[قناه السورس](t.me/Sourcekenatamee)')
end
if text == "ضع اسم للبوت ⌔" and DevkenatameW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌔' and DevkenatameW(msg) then 
...
if text == 'المشتركين ⌔' and DevkenatameW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌔︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌔' and DevkenatameW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌔︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌔") and DevkenatameW(msg) then
...
if text == ("قائمه العام ⌔") and DevkenatameW(msg) then
...
if text == ("قائمه الكتم العام ⌔") and DevkenatameW(msg) then
...
if text=="اذاعه خاص ⌔" and msg.reply_to_message_id_ == 0 and DevkenatameW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل الان اذاعتك؟* \n*⌔︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌔" and msg.reply_to_message_id_ == 0 and DevkenatameW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل الان اذاعتك؟* \n*⌔︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌔" and msg.reply_to_message_id_ == 0 and DevkenatameW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل الان اذاعتك؟* \n*⌔︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌔" and msg.reply_to_message_id_ == 0  and DevkenatameW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌔" and msg.reply_to_message_id_ == 0  and DevkenatameW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌔︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌔' and DevkenatameW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌔" and DevkenatameW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⌔" and DevkenatameW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*⌔︙عدد الكروبات الان » { '..#group..' }'..kenatamek..''..kenatame..'*\n*⌔︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevkenatameW(msg) then
...
usertext = '*\n ⌔︙العضو »* ['..result.title_..'](t.me/'..(username or 'Sourcekenatamee')..')'
status  = '\n *⌔︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevkenatameW(msg) then
...
usertext = '\n *⌔︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Sourcekenatamee')..')'
status  = '\n*⌔︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevkenatameW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevkenatameW(msg) then
...
local kenatame1_Msg = database:get(bot_id.."kenatame1:Add:Filter:Rp2"..text..msg.chat_id_)   
if kenatame1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌔︙العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Sourcekenatamee')..') \n ⌔︙'..kenatame1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if kenatame_Msg and not Special(msg) then  
local kenatame_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if kenatame_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌔︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌔︙["..kenatame_Msg.."] \n")
else
send(msg.chat_id_,0," *⌔︙العضو :* {["..data.first_name_.."](T.ME/Sourcekenatamee)}\n⌔︙["..kenatame_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " *⌔︙عذرا »* {["..data.first_name_.."](T.ME/Sourcekenatamee)}\n*⌔︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevkenatameW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevkenatameW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevkenatameW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌔︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevkenatameW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌔︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌔" and DevkenatameW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌔︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌔$") and DevkenatameW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌔︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌔" and DevkenatameW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⌔" and DevkenatameW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌔︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌔" and DevkenatameW(msg) then  
...
database:sadd(bot_id.."kenatame:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."kenatame:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_kenatame = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_kenatame then 
names_kenatame = database:smembers(bot_id.."kenatame:blocname"..msg.chat_id_) or ""
if names_kenatame and names_kenatame[1] then 
for i=1,#names_kenatame do 
if name_kenatame:match("(.*)("..names_kenatame[i]..")(.*)") then 
...
database:set(bot_id.."kenatame:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."kenatame:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."kenatame:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."kenatame:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."kenatame:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_kenatamea_new(kenatame1,kenatame2)
if kenatame2 and kenatame2.first_name_ then 
if kenatame2.first_name_:match("(.*)"..database:get(bot_id.."kenatame:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."kenatame:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local kenatame_nnn = database:get(bot_id.."kenatame:nump"..msg.chat_id_) or 5
local kenatame_nnn2 = database:get(bot_id.."kenatame:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(kenatame_nnn2) == tonumber(kenatame_nnn) or tonumber(kenatame_nnn2) > tonumber(kenatame_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."kenatame:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌔︙عزيزي >>["..kenatame2.username_.."](https://t.me/"..(kenatame2.username_ or "Sourcekenatamee")..")\n⌔︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."kenatame:teh"..msg.chat_id_).."} بجانب اسمك\n⌔︙عدد المحاولات المتبقيه {"..(tonumber(kenatame_nnn) - tonumber(kenatame_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_kenatamea_new)
end
end
...
local kenatameChengName = database:get(bot_id.."kenatame:Cheng:Name"..data.id_)
if not data.first_name_ then 
if kenatameChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..kenatameChengName..']')
database:del(bot_id.."kenatame:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if kenatameChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."kenatame:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local kenatameChengUserName = database:get(bot_id.."kenatame:Cheng:UserName"..data.id_)
if not data.username_ then 
if kenatameChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..kenatameChengUserName..']')
database:del(bot_id.."kenatame:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if kenatameChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."kenatame:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local kenatameChengPhoto = database:get(bot_id.."kenatame:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if kenatameChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."kenatame:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if kenatameChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."kenatame:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = [[
┌────── SM ──────┐
♚︙𝘸𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘴𝘰𝘶𝘳𝘤𝘦 ⁦ ᴸᴱᴬᴰᴱᴿˁᴴᴵᴾ
                      ♚الُــــــقٌـ,ـياڊة♚          
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
♚︙ [Source channel](https://t.me/KKK25)
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
♚︙[Devlopr](https://t.me/KNKKO)
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
♚︙[Bot Connect](t.me/XXKK40_bot) 
└────── SM──────┘
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
if text == 'رفع نسخه الاحتياطيه' and DevkenatameW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *⌔︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Sourcekenatamee')..') \n*⌔︙تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌔︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Sourcekenatamee')..') \n*⌔︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevkenatameW(msg) then    
dofile('kenatame.lua')  
send(msg.chat_id_, msg.id_, ' *⌔︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevkenatameW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevkenatameW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if kenatameSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevkenatameW(msg) then
...
if kenatameSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌔︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevkenatameW(msg) then
...
if kenatameSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌔︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevkenatameW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevkenatameW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevkenatameW(msg) then
...
if kenatameSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌔︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevkenatameW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevkenatameW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevkenatameW(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevkenatameW(msg) then
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevkenatameW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevkenatameW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "Sourcekenatamee")
...
function Function_kenatame(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_kenatame, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_kenatame, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌔︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Sourcekenatamee')..')'
status  = '\n*⌔︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌔︙العضو »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌔︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Sourcekenatamee')..')'
...
database:set(bot_id.."kenatame1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."kenatame1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌔︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."kenatame1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."kenatame1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."kenatame1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."kenatame1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌔︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."kenatame1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."kenatame1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."kenatame1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."kenatame1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⌔︙ارسل الكلمه الان*")  
database:set(bot_id.."kenatame1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."kenatame1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."kenatame1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."kenatame1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."kenatame1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."kenatame1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."kenatame1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."kenatame1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."kenatame1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n *⌔︙قائمة المنع* \n*ٴ┉ ┉ ┉ ┉ ┉ 𝑳𝐍 ┉  ┉ ┉ ┉ ┉ٴ*\n"
for k,v in pairs(list) do  
local kenatame_Msg = database:get(bot_id.."kenatame1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..kenatame_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevkenatameW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌔︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevkenatameW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌔︙العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'Sourcekenatamee')..')'..'\n*⌔︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevkenatameW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevkenatameW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'القياده').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'القياده')
local kenatame_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..kenatame_Msg[math.random(#kenatame_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevkenatameW(msg) then 
...
},function(ta,kenatame)
local t = "\n*ツ قائمة الاعضاء* \n*ٴ┉ ┉ ┉ ┉ ┉ 𝑳𝐍 ┉  ┉ ┉ ┉ ┉ٴ*\n"
x = 0
local list = kenatame.members_
for k, v in pairs(list) do
x = x + 1
...
if kenatameSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevkenatameW(msg) then 
...
if text == ("ردود المطور") and DevkenatameW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌔︙قائمة ردود المطور \n*ٴ┉ ┉ ┉ ┉ ┉ 𝑳𝐍 ┉  ┉ ┉ ┉ ┉ٴ*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevkenatameW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevkenatameW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'القياده').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevkenatameW(msg) then   
...
if text == 'تعطيل المغادره' and DevkenatameW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⌔︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'kenatame')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Sourcekenatamee')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
kenatamedx(msg.chat_id_, msg.id_, ' *⌔︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌔︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌔︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌔︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevkenatameW(msg) then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑳𝐀𝐑𝐕𝐈𝐍 𝐓𝐄𝐀𝐌.',url="t.me/Sourcekenatamee"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'القياده')
...
kenatame = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(kenatame)
...
--------------------------------------------------------------------------------------------------------------
Sourcekenatame(data.message_,data)
...
------------------------------------------------------------------------
local kenatameAbot = database:get(bot_id.."kenatame1:Add:Filter:Rp2"..text..result.chat_id_)   
if kenatameAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌔︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌔︙["..kenatameAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local kenatame1_Msg = database:get(bot_id.."kenatame1:Add:Filter:Rp2"..text..result.chat_id_)   
if kenatame1_Msg then    
send(msg.chat_id_, msg.id_," ⌔︙"..kenatame1_Msg)
