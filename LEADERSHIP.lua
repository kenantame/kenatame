...
> CH › @SourceLEADERSHIPe
~> DEVELOPER › @VvBvV
]])
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/LEADERSHIPNTEAM/Files_LEADERSHIP/main/File_Bot/commands.lua") 
...
function LEADERSHIPSudoBot(sudo)  
local TEND = false  
for k,v in pairs(sudo_users) do  
...
if hash or SudoBot(msg) or DevLEADERSHIPW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevLEADERSHIPW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevLEADERSHIPW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevLEADERSHIPW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLEADERSHIPW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLEADERSHIPW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLEADERSHIPW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "SourceLEADERSHIPe")
...
local LEADERSHIP_Msg = ''  
if msgs < 100 then 
LEADERSHIP_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
LEADERSHIP_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
LEADERSHIP_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
LEADERSHIP_Msg = 'متفاعل' 
elseif msgs < 1200 then 
LEADERSHIP_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
LEADERSHIP_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
LEADERSHIP_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
LEADERSHIP_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
LEADERSHIP_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
LEADERSHIP_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
LEADERSHIP_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
LEADERSHIP_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
LEADERSHIP_Msg = 'رب التفاعل'  
end 
...
--------------------------------------------------------------------------------------------------------------
function SourceLEADERSHIP(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
if DevLEADERSHIPW(msg) then
local bl = ' *⌔︙اهلا عزيزي آلمـطـور*\n*⌔︙آنت آلمـطـور آلآسـآسـي للبوت*\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n*⌔︙تسـتطـيع‌‏ آلتحگم باوامر البوت*\n*⌔︙من خلاال الكيبورت خاص بك*\n*⌔︙قناة سورس البوت *[اضغط هنا](t.me/SourceLEADERSHIPe)'
local keyboard = {
...
if start then 
SourceLEADERSHIPr = start
else
Namot = (database:get(bot_id..'Name:Bot') or 'لارفين')
SourceLEADERSHIPr = '*⌔︙اهلا عزيزي*\n*⌔︙انا بوت اسمي '..Namot..'*\n*⌔︙اختصاصي حمايه الكروبات*\n*⌔︙من تكرار والسبام والتوجيه والخ…*\n*⌔︙لتفعيلي اتبع الاخطوات…↓*\n*⌔︙اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط*\n⌔︙[قناة سورس البوت](http://t.me/SourceLEADERSHIPe)'
end
send(msg.chat_id_, msg.id_, SourceLEADERSHIPr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevLEADERSHIPW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevLEADERSHIPW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,LEADERSHIP_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ⌔' and DevLEADERSHIPW(msg) then  
...
if text == 'تعطيل التواصل ⌔' and DevLEADERSHIPW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌔' and DevLEADERSHIPW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌔' and DevLEADERSHIPW(msg) then  
...
if text == 'ضع كليشه ستارت ⌔' and DevLEADERSHIPW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌔︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌔' and DevLEADERSHIPW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌔︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌔' and DevLEADERSHIPW(msg) then 
...
if text == 'تحديث السورس ⌔' and DevLEADERSHIPW(msg) then 
os.execute('rm -rf LEADERSHIP.lua')
os.execute('wget https://raw.githubusercontent.com/LEADERSHIPNTEAM/LEADERSHIP/main/LEADERSHIP.lua')
send(msg.chat_id_, msg.id_,' *⌔︙تم تحديث السورس* \n*⌔︙لديك اخر اصدار لسورس لارفين*\n*⌔︙الاصدار » { 2.8v}*')
dofile('LEADERSHIP.lua')  
end
if text == 'الاصدار ⌔' and DevLEADERSHIPW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌔︙اصدار سورس لارفين* \n*⌔︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌔' and DevLEADERSHIPW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌔︙[تحديثات البوت](t.me/SourceLEADERSHIPe) \n⌔︙[قناه السورس](t.me/SourceLEADERSHIPe)')
end
if text == "ضع اسم للبوت ⌔" and DevLEADERSHIPW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌔' and DevLEADERSHIPW(msg) then 
...
if text == 'المشتركين ⌔' and DevLEADERSHIPW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌔︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌔' and DevLEADERSHIPW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌔︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌔") and DevLEADERSHIPW(msg) then
...
if text == ("قائمه العام ⌔") and DevLEADERSHIPW(msg) then
...
if text == ("قائمه الكتم العام ⌔") and DevLEADERSHIPW(msg) then
...
if text=="اذاعه خاص ⌔" and msg.reply_to_message_id_ == 0 and DevLEADERSHIPW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل الان اذاعتك؟* \n*⌔︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌔" and msg.reply_to_message_id_ == 0 and DevLEADERSHIPW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل الان اذاعتك؟* \n*⌔︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌔" and msg.reply_to_message_id_ == 0 and DevLEADERSHIPW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل الان اذاعتك؟* \n*⌔︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌔" and msg.reply_to_message_id_ == 0  and DevLEADERSHIPW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌔" and msg.reply_to_message_id_ == 0  and DevLEADERSHIPW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌔︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌔' and DevLEADERSHIPW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌔" and DevLEADERSHIPW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⌔" and DevLEADERSHIPW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local LEADERSHIP = (w + q)
local sendok = #group - LEADERSHIP
if q == 0 then
LEADERSHIP = ''
else
...
send(msg.chat_id_, msg.id_,'*⌔︙عدد الكروبات الان » { '..#group..' }'..LEADERSHIPk..''..LEADERSHIP..'*\n*⌔︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevLEADERSHIPW(msg) then
...
usertext = '*\n ⌔︙العضو »* ['..result.title_..'](t.me/'..(username or 'SourceLEADERSHIPe')..')'
status  = '\n *⌔︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevLEADERSHIPW(msg) then
...
usertext = '\n *⌔︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLEADERSHIPe')..')'
status  = '\n*⌔︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevLEADERSHIPW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevLEADERSHIPW(msg) then
...
local LEADERSHIP1_Msg = database:get(bot_id.."LEADERSHIP1:Add:Filter:Rp2"..text..msg.chat_id_)   
if LEADERSHIP1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌔︙العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceLEADERSHIPe')..') \n ⌔︙'..LEADERSHIP1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if LEADERSHIP_Msg and not Special(msg) then  
local LEADERSHIP_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if LEADERSHIP_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌔︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌔︙["..LEADERSHIP_Msg.."] \n")
else
send(msg.chat_id_,0," *⌔︙العضو :* {["..data.first_name_.."](T.ME/SourceLEADERSHIPe)}\n⌔︙["..LEADERSHIP_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " *⌔︙عذرا »* {["..data.first_name_.."](T.ME/SourceLEADERSHIPe)}\n*⌔︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevLEADERSHIPW(msg) then
...
'\n *⌔︙الرابط* {['..LinkGp..']}'
if not DevLEADERSHIPW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevLEADERSHIPW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevLEADERSHIPW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌔︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevLEADERSHIPW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌔︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌔" and DevLEADERSHIPW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌔︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌔$") and DevLEADERSHIPW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌔︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌔" and DevLEADERSHIPW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⌔" and DevLEADERSHIPW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌔︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌔" and DevLEADERSHIPW(msg) then  
...
database:sadd(bot_id.."LEADERSHIP:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."LEADERSHIP:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_LEADERSHIP = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_LEADERSHIP then 
names_LEADERSHIP = database:smembers(bot_id.."LEADERSHIP:blocname"..msg.chat_id_) or ""
if names_LEADERSHIP and names_LEADERSHIP[1] then 
for i=1,#names_LEADERSHIP do 
if name_LEADERSHIP:match("(.*)("..names_LEADERSHIP[i]..")(.*)") then 
...
database:set(bot_id.."LEADERSHIP:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."LEADERSHIP:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."LEADERSHIP:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."LEADERSHIP:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."LEADERSHIP:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_LEADERSHIPa_new(LEADERSHIP1,LEADERSHIP2)
if LEADERSHIP2 and LEADERSHIP2.first_name_ then 
if LEADERSHIP2.first_name_:match("(.*)"..database:get(bot_id.."LEADERSHIP:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."LEADERSHIP:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local LEADERSHIP_nnn = database:get(bot_id.."LEADERSHIP:nump"..msg.chat_id_) or 5
local LEADERSHIP_nnn2 = database:get(bot_id.."LEADERSHIP:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(LEADERSHIP_nnn2) == tonumber(LEADERSHIP_nnn) or tonumber(LEADERSHIP_nnn2) > tonumber(LEADERSHIP_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."LEADERSHIP:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌔︙عزيزي >>["..LEADERSHIP2.username_.."](https://t.me/"..(LEADERSHIP2.username_ or "SourceLEADERSHIPe")..")\n⌔︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."LEADERSHIP:teh"..msg.chat_id_).."} بجانب اسمك\n⌔︙عدد المحاولات المتبقيه {"..(tonumber(LEADERSHIP_nnn) - tonumber(LEADERSHIP_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_LEADERSHIPa_new)
end
end
...
local LEADERSHIPChengName = database:get(bot_id.."LEADERSHIP:Cheng:Name"..data.id_)
if not data.first_name_ then 
if LEADERSHIPChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..LEADERSHIPChengName..']')
database:del(bot_id.."LEADERSHIP:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if LEADERSHIPChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."LEADERSHIP:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local LEADERSHIPChengUserName = database:get(bot_id.."LEADERSHIP:Cheng:UserName"..data.id_)
if not data.username_ then 
if LEADERSHIPChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..LEADERSHIPChengUserName..']')
database:del(bot_id.."LEADERSHIP:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if LEADERSHIPChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."LEADERSHIP:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local LEADERSHIPChengPhoto = database:get(bot_id.."LEADERSHIP:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if LEADERSHIPChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."LEADERSHIP:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if LEADERSHIPChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."LEADERSHIP:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
⌔︙LEADERSHIP TEAM
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⌔︙[Source Files](http://t.me/SourceLEADERSHIPe)

⌔︙[Source Channel](https://t.me/i600ik/15)

⌔︙[TWS LEADERSHIP](http://t.me/vBvbot) 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
...
if text == 'رفع نسخه الاحتياطيه' and DevLEADERSHIPW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *⌔︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceLEADERSHIPe')..') \n*⌔︙تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌔︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SourceLEADERSHIPe')..') \n*⌔︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevLEADERSHIPW(msg) then    
dofile('LEADERSHIP.lua')  
send(msg.chat_id_, msg.id_, ' *⌔︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevLEADERSHIPW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevLEADERSHIPW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if LEADERSHIPSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevLEADERSHIPW(msg) then
...
if LEADERSHIPSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌔︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevLEADERSHIPW(msg) then
...
if LEADERSHIPSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌔︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevLEADERSHIPW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevLEADERSHIPW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevLEADERSHIPW(msg) then
...
if LEADERSHIPSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌔︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevLEADERSHIPW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevLEADERSHIPW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevLEADERSHIPW(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevLEADERSHIPW(msg) then
...
if text == 'الملفات' and DevLEADERSHIPW(msg) then
...
if DevLEADERSHIPW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/LEADERSHIPNTEAM/Files_LEADERSHIP/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *⌔︙اهلا بك في متجر ملفات لارفين*\n*⌔︙ملفات السورس ↓*\n*ٴ┉ ┉ ┉ ┉ ┉ 𝑳𝐍 ┉  ┉ ┉ ┉ ┉ٴ*\n\n"
local TextE = "\n*ٴ┉ ┉ ┉ ┉ ┉ 𝑳𝐍 ┉  ┉ ┉ ┉ ┉ٴ*\n *⌔︙علامة تعني { ✓ } ملف مفعل*\n *⌔︙علامة تعني { ✘ } ملف معطل*\n *⌔︙قناة سورس لارفين ↓*\n".." *⌔︙*[اضغط هنا لدخول](t.me/SourceLEADERSHIPe) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevLEADERSHIPW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/LEADERSHIPNTEAM/Files_LEADERSHIP/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevLEADERSHIPW(msg) then
...
if text == "مسح الملفات" and DevLEADERSHIPW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌔︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevLEADERSHIPW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevLEADERSHIPW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "SourceLEADERSHIPe")
...
function Function_LEADERSHIP(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_LEADERSHIP, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_LEADERSHIP, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌔︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLEADERSHIPe')..')'
status  = '\n*⌔︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌔︙العضو »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌔︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLEADERSHIPe')..')'
...
database:set(bot_id.."LEADERSHIP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."LEADERSHIP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌔︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."LEADERSHIP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."LEADERSHIP1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."LEADERSHIP1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."LEADERSHIP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌔︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."LEADERSHIP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."LEADERSHIP1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."LEADERSHIP1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."LEADERSHIP1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⌔︙ارسل الكلمه الان*")  
database:set(bot_id.."LEADERSHIP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."LEADERSHIP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."LEADERSHIP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."LEADERSHIP1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."LEADERSHIP1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."LEADERSHIP1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."LEADERSHIP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."LEADERSHIP1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."LEADERSHIP1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n *⌔︙قائمة المنع* \n*ٴ┉ ┉ ┉ ┉ ┉ 𝑳𝐍 ┉  ┉ ┉ ┉ ┉ٴ*\n"
for k,v in pairs(list) do  
local LEADERSHIP_Msg = database:get(bot_id.."LEADERSHIP1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..LEADERSHIP_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevLEADERSHIPW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌔︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevLEADERSHIPW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌔︙العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'SourceLEADERSHIPe')..')'..'\n*⌔︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevLEADERSHIPW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevLEADERSHIPW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..LEADERSHIP_Msg[math.random(#LEADERSHIP_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevLEADERSHIPW(msg) then 
...
},function(ta,LEADERSHIP)
local t = "\n*ツ قائمة الاعضاء* \n*ٴ┉ ┉ ┉ ┉ ┉ 𝑳𝐍 ┉  ┉ ┉ ┉ ┉ٴ*\n"
x = 0
local list = LEADERSHIP.members_
for k, v in pairs(list) do
x = x + 1
...
if LEADERSHIPSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevLEADERSHIPW(msg) then 
...
if text == ("ردود المطور") and DevLEADERSHIPW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌔︙قائمة ردود المطور \n*ٴ┉ ┉ ┉ ┉ ┉ 𝑳𝐍 ┉  ┉ ┉ ┉ ┉ٴ*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevLEADERSHIPW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevLEADERSHIPW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevLEADERSHIPW(msg) then   
...
if text == 'تعطيل المغادره' and DevLEADERSHIPW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⌔︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'LEADERSHIP')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLEADERSHIPe')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
LEADERSHIPdx(msg.chat_id_, msg.id_, ' *⌔︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌔︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌔︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌔︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevLEADERSHIPW(msg) then
...
ٴ≪┉ ┉ ┉ ┉ ┉ 𝑳𝐍 ┉  ┉ ┉ ┉ ┉≫ٴ
*⌔︙م1 1⃣◂ اوامر الحمايه*
*⌔︙م2 2⃣◂ اوامر تعطيل ~ تفعيل*
*⌔︙م3 3⃣◂ اوامر ضع ~ اضف*
*⌔︙م4 4⃣◂ اوامر مسح ~ حذف*
*⌔︙م5 5⃣◂ اوامر تنزيل+رفع+التغير*
*⌔︙م6 6⃣◂ اوامر الكروب*
*⌔︙م7 7⃣◂ اوامر التحشيش*
*⌔︙م8 8⃣◂ اوامر مطور البوت*
*⌔︙م9 9⃣◂ اوامر مطور الاساسي* 
*⌔︙م10 🔟◂ اوامر الاعضاء*
ٴ≪┉ ┉ ┉ ┉ ┉ 𝑳𝐍 ┉  ┉ ┉ ┉ ┉≫ٴ
...
{{text = '𝑳𝐀𝐑𝐕𝐈𝐍 𝐓𝐄𝐀𝐌.',url="t.me/SourceLEADERSHIPe"}},
}
...
LEADERSHIP = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(LEADERSHIP)
...
--------------------------------------------------------------------------------------------------------------
SourceLEADERSHIP(data.message_,data)
...
------------------------------------------------------------------------
local LEADERSHIPAbot = database:get(bot_id.."LEADERSHIP1:Add:Filter:Rp2"..text..result.chat_id_)   
if LEADERSHIPAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌔︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌔︙["..LEADERSHIPAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local LEADERSHIP1_Msg = database:get(bot_id.."LEADERSHIP1:Add:Filter:Rp2"..text..result.chat_id_)   
if LEADERSHIP1_Msg then    
send(msg.chat_id_, msg.id_," ⌔︙"..LEADERSHIP1_Msg)
